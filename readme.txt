...
LianaMailer for Contact Form 7 is an integration plugin for a [Contact Form 7](https://wordpress.org/plugins/contact-form-7/) plugin which integrates LianaMailer into Contact Form 7.

= Contribute and translate =

LianaMailer for Contact Form 7 plugin is developed and supported by Liana Technologies Oy. Join our crew at GitHub or contact using other means.
